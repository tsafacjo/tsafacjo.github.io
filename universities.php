...
<body>
	...
	<div class="container-fluid" id="couleur">
			...
			<div class="container" id="corps">
				...
				<div class="row">
				<div id ="citylist" class="col-sm-3"> 
				<h2>City</h2>
				<ul>
					<li><a href="#">Li Tchan</a></li>
					<li><a href="#">Li Tchan</a></li>
					<li><a href="#">Li Tchan</a></li>
					<li><a href="#">Li Tchan</a></li>
					<li><a href="#">Li Tchan</a></li>
					...
					<caption><h2>Universities</h2></caption>
						<thead>
						...
						<tr>
							...
							<td>
								<img class="col-sm-6" src="shan2.jpg" ><span>Name of university</span><br><a data-toggle="modal" href="#info"><span id="more">more</span></a>
								<div class="modal fade" id="info">
									<div class="modal-dialog modal-lg">
									<div class="modal-content">
										<div class="modal-header">
											<button  class="close" data-dismiss="modal">x</button>
												<h4 class="modal-title">Name of university</h4>
										</div>
										<div class="modal-body">
										
										
										Information, contact, Adress,image
							...
							<td><img class="col-sm-6" src="index.jpg" ><span>Name of university</span><button class="btn btn-link ">more</button></td>
							<td><img class="col-sm-6" src="shan2.jpg" ><span>Name of university</span><button class="btn btn-link ">more</button></td>
							<td><img class="col-sm-6" src="shan2.jpg" ><span>Name of university</span><button class="btn btn-link ">more</button></td>
							<td><img class="col-sm-6" src="shan2.jpg" ><span>Name of university</span><button class="btn btn-link ">more</button></td>
						...
						<tr>
							<td><img class="col-sm-4" src="shan2.jpg" ><span>Name of university</span><center><button class="btn btn-link">more</button></center></td>
							<td><img class="col-sm-4" src="shan2.jpg" ><span>Name of university</span><center><button class="btn btn-link ">more</button></center></td>
							<td><img class="col-sm-4" src="shan2.jpg" ><span>Name of university</span><center><button class="btn btn-link ">more</button></center></td>
							<td><img class="col-sm-4" src="shan2.jpg" ><span>Name of university</span><center><button class="btn btn-link ">more</button></center></td>
